	...
	<fieldset class="fieldForm" id="fieldUsuario">
		...
		<div class="itensForm">
			...
			<form class="formulario" method="post" action="">							
				<p>Nome:</p>
				<input type="text" name="nomeUsuario" size="35" placeholder="ex.: Fulano da Silva" maxlength="150">

				<p>E-mail:</p>
				<input type="email" name="emailUsuario" size="35" placeholder="fulano@email" maxlength="200">

				<p>Usuário:</p>
				<input type="text" name="loginUsuario" size="35" placeholder="nome do login" maxlength="100">

				<p>Função:</p>
				<select name="loginUsuario" class="funcao">						
				...
				<p>Senha:</p>
				<input type="password" name="senhaUsuario" size="13" placeholder="*******" maxlength="30">							
				<p></p>
				<input type="password" name="senhaUsuario" size="13" placeholder="repita a senha" maxlength="30">
